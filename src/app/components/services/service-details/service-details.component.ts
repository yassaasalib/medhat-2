  ...
  template: `
    <section class="service-details min-h-screen bg-black text-white py-32">
      <div class="max-w-6xl mx-auto px-8">
        <a routerLink="/services" class="inline-block mb-8 text-gray-400 hover:text-white transition-colors">
          ← Back to Services
        </a>
        ...
        <div *ngIf="service" class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <button class="w-full mt-8 py-4 px-6 bg-white text-black hover:bg-gray-200 transition-colors rounded-lg text-lg">
              Book Now
            </button>
          </div>
        </div>
